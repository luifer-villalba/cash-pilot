...
class TestCashSessionProperties:
    ...
    async def test_total_sales_all_payment_methods(self):
        ...
        session = CashSession(
            ...
            bank_transfer_total=Decimal("150000.00"),  # REMOVED debit_card_total
        )

        # cash_sales = (1,200,000 - 500,000) - 300,000 = 400,000
