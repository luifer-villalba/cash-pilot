# File: src/cashpilot/models/transfer_item.py
"""Bank transfer line item model."""
...
class TransferItem(Base):
    """Bank transfer line item."""

    __tablename__ = "transfer_items"
    __table_args__ = (CheckConstraint("amount >= 0", name="transfer_item_amount_non_negative"),)
    ...
    def is_valid(self) -> bool:
        """Check if the transfer item is valid."""
        return (
            self.amount >= 0
    ...
    def __repr__(self) -> str:
        ...
        return f"<TransferItem(id={self.id}, amount={self.amount}, description={desc})>"
